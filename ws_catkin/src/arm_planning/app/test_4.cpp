...
/** @brief 
 * robot: panda
 * planning goal: task-space
 * constraints: in-path pose constraint (z-axis down). 
    * Note: we haven't implemented the constraints as args, so they should be specified in the source code.
 * algorithm: ATACE, CBiRRT
 */
...
int main(int argc, char** argv){
    ...
    // ---------------------- do planning ---------------------------
    std::vector<std::string> test_algorthms{"CBiRRT", "ATACE"};
