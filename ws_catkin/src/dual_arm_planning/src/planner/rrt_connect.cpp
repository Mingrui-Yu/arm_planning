...
bool RRTConnect::solve(
    ...
    ROS_ERROR_COND(checkNodeCollision(start_node), "The start node is in collision / out of the joint bounds.");
    ROS_ERROR_COND(checkNodeCollision(goal_node), "The goal node is in collision / out of the joint bounds.");
