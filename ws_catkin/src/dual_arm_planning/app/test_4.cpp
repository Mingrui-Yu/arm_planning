...
int main(int argc, char** argv){
    ...
    geometry_msgs::Pose arm_0_goal_pose, arm_1_goal_pose;
    arm_0_goal_pose.position.x = 0.2;
    arm_0_goal_pose.position.y = -attached_box_size(0) / 2.0;
    arm_0_goal_pose.position.z = -0.4;
    arm_0_goal_pose.orientation.w = 1.0;
    arm_1_goal_pose.position.x = 0.2;
    arm_1_goal_pose.position.y = attached_box_size(0) / 2.0;
    arm_1_goal_pose.position.z = -0.4;
    arm_1_goal_pose.orientation.w = 1.0;

    /**
     * pre-calculate the joint positions of the start configuration using IK 
     * this is more convenient for users to define the start configuration
     */
    ...
    req.arm_0_goal_pose_ = arm_0_goal_pose;
    req.arm_1_goal_pose_ = arm_1_goal_pose;
    req.constraint_tcp_relative_pose_ = constraint_tcp_relative_pose; // constraint of the arm_1 tcp pose in the arm_0 tcp frame
